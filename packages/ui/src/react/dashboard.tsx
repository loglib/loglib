...
import { Activity, ArrowUpIcon, Asterisk, Calendar, CalendarDays, Eye, MapPin, MonitorSmartphone, PanelTop, Plus, Timer, Users } from "lucide-react"
                ...
                <div className="bg-white min-h-screen w-full  dark:bg-black transition-all duration-700 dark:text-white/90">
                    ...
                    <div className="flex-1 space-y-4 p-8 pt-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div
                                className="lg:flex flex-col justify-center items-center col-span-1 self-center select-none relative"
                            >
                                <div
                        ...
                        <Tabs defaultValue="overview" className="space-y-4" orientation="vertical">
                            <TabsList>
                                <TabsTrigger value="overview" className="data-[state=active]:text-emphasis">Insights</TabsTrigger>
                                <TabsTrigger value="analytics" className="data-[state=active]:text-emphasis">Events</TabsTrigger>
                                {/* <TabsTrigger  className="data-[state=active]:text-emphasis">
                                    Events
                                </TabsTrigger> */}
                            ...
                            <div className=" flex space-x-2 items-center">
                                <Select onValueChange={(value) => setTimeRange(value)} defaultValue="24hr">
                                ...
                                <Popover>
                                    ...
                                    <PopoverContent className="w-auto space-y-2" align="start">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <Select onValueChange={(value) => setTimeRange(value)} defaultValue="is">
                                        ...
                                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                                            ...
                                            <Card className="col-span-3">
                                                <Tabs defaultValue="pages">
                                                    ...
                                                    <CardContent>
                                                        <Table>
                                                            <TableCaption>Your pages and how many times they are visited {":)"}</TableCaption>
                                                            <TableHeader>
