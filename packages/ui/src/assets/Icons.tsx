import LogoIcon from "@/react/components/Icon/LogoIcon";
import {
  ArrowUpRight,
  Facebook,
  Github,
...
export const RefIcons = {
  ...
  google: () => (
    <svg
      ...
      width={16}
      height={16}
      className=" tw-stroke-black tw-stroke-2 dark:tw-stroke-white fill-none"
      id="b"
      xmlns="http://www.w3.org/2000/svg"
    >
  ...
  loglib: () => <LogoIcon className=" tw-h-4 tw-w-4 md:tw-h-5 md:tw-w-5" />,
  android: () => (
    <svg
      viewBox="0 0 24 24"
      version="1.1"
          ...
          >
            ...
            <g id="Android_2_line" transform="translate(0.000000, 96.000000)">
              ...
              <path
                ...
                id="形状"
                className=" tw-fill-black dark:tw-fill-white"
              >
                {" "}
              </path>{" "}
            </g>{" "}
