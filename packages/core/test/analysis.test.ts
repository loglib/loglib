...
import {
  ...
  getReferer,
  getNewVisitors,
} from "../src/router/routes/dashboard/utils";
...
describe("getReferer", (it) => {
  ...
  it("should group sessions by referrer", () => {
    ...
    expect(result).toEqual([
      { referrer: "Example", visits: 4, referrerDomain: "https://example.com" },
    ]);
  });
    ...
    expect(result).toEqual([
      {
        referrer: "Google",
        visits: 2,
        referrerDomain: "https://google.com",
      },
