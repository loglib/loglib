...
<div
  class="rounded-xl md:rounded-3xl border dark:border-slate-800 border-slate-100 relative bg-slate-950 overflow-hidden h-full"
>
  <svg
    width="325"
    height="351"
    viewBox="0 0 325 351"
    fill="none"
    class="absolute right-0 top-0 pointer-events-none select-none"
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stop-color="#7FBCDB" />
        <stop offset="1" stop-color="#3467E9" />
      </linearGradient>
      <linearGradient
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0.605709" stop-color="white" stop-opacity="0" />
        <stop offset="0.81137" stop-color="white" />
      </linearGradient>
    </defs>
  </svg>
  <div class="p-5 md:p-10 h-full flex flex-col">
    <h3 class="text-slate-200 text-xl md:text-3xl font-medium mb-4">
      Insight <span class=" text-slate-300">Tables</span>
    </h3>
    <p class="text-white/50 text-base md:text-lg font-medium mb-8 max-w-md">
      Tables that show you just what is important about your website
    </p>
    <div
      class="h-40 md:h-72 relative w-full rounded-xl flex justify-end items-end flex-col gap-2"
    >
      <div class="  overflow-clip absolute h-1/2 -bottom-2 -right-40">
        <img
          alt="Feature 1"
          draggable="false"
          decoding="async"
  ...
  <div class=" rounded-full absolute top-2 right-2">
    <div
      class="md:h-14 md:w-14 h-10 w-10 border border-slate-800/[0.2] bg-background flex flex-shrink-0 items-center justify-center rounded-full relative"
    >
      <div
        class="h-8 md:h-12 md:w-12 w-8 rounded-full border-2 border-orange-500/60 relative overflow-hidden flex items-center justify-center"
      >
        <svg
          width="52"
          height="52"
          viewBox="0 0 52 52"
          fill="none"
          class="absolute inset-0 h-[36px] w-[36px]"
          xmlns="http://www.w3.org/2000/svg"
        >
          <g opacity="0.2">
            <rect
        ...
        <div
          class="absolute h-full flex items-center justify-center rounded-full w-full bg-slate-900"
        >
          <TableIcon size={18} class="text-orange-400" />
        </div>
      </div>
      <svg
        width="64"
        ...
        viewBox="0 0 64 64"
        fill="none"
        class="absolute inset-0 md:h-14 md:w-14 h-10 w-10 animate-spin-slow"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
        ...
        <defs>
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stop-color="#564439" />
            <stop offset="1" stop-color="#564439" stop-opacity="0" />
          </linearGradient>
          <linearGradient
