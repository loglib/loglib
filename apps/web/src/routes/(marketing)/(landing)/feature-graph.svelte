...
<div
  class="rounded-xl md:rounded-3xl border dark:border-slate-800 border-slate-100 relative bg-slate-950/40 overflow-hidden h-full"
>
  <svg
    width="325"
    height="351"
  ...
  <div class="p-5 md:p-10 h-full flex flex-col">
    <h3 class="text-slate-200 text-xl md:text-3xl font-medium mb-4">
      Visualize <span class=" text-slate-300">Your data</span>
    </h3>
    ...
    >
      <div class="  overflow-clip absolute -right-40">
        <img
          alt="Feature 1"
          draggable="false"
          decoding="async"
  ...
  <div class=" rounded-full absolute top-2 right-2">
    ...
    >
      ...
      >
        ...
        >
          <MapIcon size={18} class=" text-orange-400" />
        </div>
      </div>
      <svg
        width="64"
