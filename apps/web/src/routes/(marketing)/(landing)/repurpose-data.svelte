...
<section class=" w-full bg-slate-950">
  <GridBackground />
  <div class="border-y border-slate-900 py-16 md:py-20 relative">
    <div
      class=" bg-[#303a75] border-t border-slate-800 transition-all duration-500 w-full absolute bottom-0 blur-md"
      id="border"
    />
    <div class="max-w-screen-lg px-6 mx-auto grid md:grid-cols-2 gap-12">
      <div
        class="flex flex-col items-center md:items-start text-center md:text-left order-2 md:order-none"
      >
        <h2
          class="text-3xl md:text-4xl font-semibold tracking-tight text-neutral-50"
        >
          Repurpose Your Data
        </h2>
        <p
          class="text-base font-normal tracking-normal max-w-lg mt-4 text-neutral-400 leading-7"
        >
          <span class="text-neutral-200 text-medium">
            ...
            version, either self-deployed or on loglib.io, you lose that
        ...
        <a
          href="/docs/api"
          class="border border-neutral-300 text-neutral-300 hover:bg-neutral-300 hover:text-black transition-all focus:ring focus:ring-purple-light ring-offset-1 ring-offset-black px-3 py-2 mt-6 rounded text-sm font-medium group inline-flex items-center"
        >
          See API docs
          <svg
            stroke="currentColor"
            ...
            stroke-width="0"
            viewBox="0 0 20 20"
            class="relative transition–all duration-200 left-0.5 group-focus:left-1 group-hover:left-1 w-4 h-4 ml-1"
            height="1em"
            width="1em"
      ...
      <div class="relative aspect-square mx-auto order-1 md:order-none">
        <div
          class="absolute inset-0 blur-2xl scale-110 rounded-full animate-spin-slow bg-gradient-to-tl from-slate-800 to-slate-500 opacity-40"
        />
        <div
          class="p-px bg-gradient-to-t from-slate-800/60 to-slate-700/60 rounded-3xl overflow backdrop-blur-sm"
        >
          <div
            class="bg-black/30 grid place-items-center p-7 md:p-12 rounded-3xl"
          >
            <svg
              width="71"
              height="71"
              viewBox="0 0 71 71"
              fill="none"
              class="h-20 md:h-32 w-20 md:w-32 fill-slate-300"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                ...
                fill="#DDDDDD"
                class="fill-black/80 dark:fill-[#DDDDDD]"
              />
            </svg>
          </div>
        </div>
