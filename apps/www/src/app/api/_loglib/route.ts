  ...
  if (req.body.sdkVersion) {
    ...
    if (req.body.path === "/session") {
      if (req.body.data) {
        ...
        const siteHostname = getHost(url);
        const isValidOrigin = hostname && siteHostname && hostname === siteHostname;
      ...
      const origin = (await kv.get(req.body?.sessionId as string)) as string | undefined;
