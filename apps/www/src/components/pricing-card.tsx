...
export function PricingCard({ tier, blur }: PricingCardProps) {
    return (
        ...
        >
            <div className="bg-stone-50 px-6 py-8 dark:bg-stone-900/80 sm:p-10 sm:pb-6">
                <div>
                    <h3
                ...
                <div className="mt-4 flex items-baseline text-6xl font-extrabold  text-stone-900 dark:text-stone-100">
                    {tier.priceMonthly === "Free" ? (
                        ...
                        <>
                            $ {tier.priceMonthly}
                            <span className="ml-1 text-2xl font-medium text-stone-500">/mo</span>
                        </>
                    )}
                </div>
            ...
            <div className="flex flex-1 flex-col justify-between space-y-6 bg-stone-100 px-6 pb-8 pt-6 dark:bg-stone-950/80 sm:p-10 sm:pt-6">
                ...
                <div className="rounded-md shadow">
                    <a
                        href={tier.href}
                        className=" text-logo  from-logo/10 flex items-center justify-center rounded-md border border-transparent bg-gradient-to-tr to-white/80 px-5 py-3  text-base font-bold hover:bg-stone-950 dark:to-stone-950/80"
