...
export function SectionButton({
  ...
  return (
    <button
      type="button"
      className={clsx(
        'flex flex-1 items-center gap-4 rounded-2xl border-2 bg-transparent px-4 py-4 text-left',
        'dark: bg-transparent ',
        active
          ? ['border-accent-400', 'dark:border-orange-600']
      ...
      {icon && (
        <span
          className={clsx(
            ...
            'xl:flex',
            active
              ? ['text-accent-600', 'dark:border-orange-600']
