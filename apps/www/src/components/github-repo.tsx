...
export default function GithubRepo({ url, description, stars, forks }: GithubRepoProps) {
    if (!url) {
        return null;
    }
                ...
                <div className="flex items-start justify-between">
                    <div>
                        <p className="text-2xl font-normal">
                            {orgName}/<span className="font-bold text-gray-800">{repoName}</span>
                        </p>
                ...
                <div className="flex items-end justify-between">
                    <div className="mt-4 flex items-center space-x-6">
                        <div className="flex items-start space-x-2">
                            ...
                            <div>
                                <p className="font-semibold text-gray-600">{nFormatter(stars)}</p>
                        ...
                        <div className="flex items-start space-x-2">
                            ...
                            <div>
                                <p className="font-semibold text-gray-600">{nFormatter(forks)}</p>
