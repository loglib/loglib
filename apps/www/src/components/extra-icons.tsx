...
export const DiscordIcon: React.FC<any> = ({size = 24, width, height, ...props}) => {
  return (
...
export const TwitterIcon: React.FC<any> = ({size = 24, width, height, ...props}) => {
  return (
    <svg height={size || height} viewBox="0 0 24 24" width={size || width} {...props}>
      <path
...
export const GithubIcon: React.FC<any> = ({size = 24, width, height, ...props}) => {
  return (
    <svg height={size || height} viewBox="0 0 24 24" width={size || width} {...props}>
      <path
        clipRule="evenodd"
