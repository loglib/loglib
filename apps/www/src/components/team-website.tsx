...
import { selectedTeamAtom, teamSitesModalAtom, userAtom, userWebsitesAtom } from "@/jotai/store";
    ...
    async function onSubmit() {
        ...
        try {
            ...
            toast({
                ...
                description: e.cause ?? "Could not save your team website. Try again later!",
                variant: "destructive",
            });
        }
        router.refresh();
            ...
            {modal ? (
                ...
                >
                    <motion.div
                        ...
                        className=" animate-in relative flex w-11/12 flex-col justify-center  gap-3 rounded-md border bg-gradient-to-tr from-gray-100 to-gray-200 px-8 pb-6 pt-4 dark:from-black dark:to-slate-900/20 md:w-3/12"
                    >
