...
export const InsightTables = () => {
	return (
		<div className="rounded-xl  md:rounded-3xl border dark:border-stone-800 border-stone-100 relative bg-stone-950 overflow-hidden h-full">
			<svg
				width="325"
				height="351"
				viewBox="0 0 325 351"
			...
			<div className="p-5 md:p-10 h-full flex flex-col">
				<h3 className="text-stone-200 text-xl md:text-3xl font-medium mb-4">
					Insight <span className=" text-stone-300">Tables</span>
				</h3>
				...
				<div className="h-40 md:h-72 relative w-full rounded-xl flex justify-end items-end flex-col gap-2">
					<div className="  overflow-clip absolute h-1/2 -bottom-2 -right-40">
						<Image
							alt="Feature 1"
							draggable="false"
							decoding="async"
