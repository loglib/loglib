...
export const InsightTables = () => {
    return (
        <div className="rounded-xl  md:rounded-3xl border dark:border-slate-800 border-slate-100 relative bg-slate-950 overflow-hidden h-full">
            <svg
                width="325"
                height="351"
                viewBox="0 0 325 351"
            ...
            <div className="p-5 md:p-10 h-full flex flex-col">
                <h3 className="text-slate-200 text-xl md:text-3xl font-medium mb-4">
                    Insight <span className=" text-slate-300">Tables</span>
                </h3>
