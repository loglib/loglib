...
>(({ className, ...props }, ref) => (
    ...
    >
        <SwitchPrimitives.Thumb
            className={cn(
                "bg-background pointer-events-none block h-5 w-5 rounded-full shadow-lg ring-0 transition-transform data-[state=checked]:transtone-x-5 data-[state=unchecked]:transtone-x-0",
            )}
        />
    </SwitchPrimitives.Root>
));
