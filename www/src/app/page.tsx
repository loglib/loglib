    ...
    <main className="  grid place-items-center  space-y-10 md:space-y-20">
      <header className="max-w-8xl w-full pt-4">
        ...
        <div className="mt-4 space-y-5">
          <hr
            className="border-1 ml-auto mr-8 w-8/12 animate-pulse border-[#877474]"
          />
          <div className="flex items-center space-x-4">
            <hr
              className="w-3/12 animate-pulse border-gray-400/50 md:w-7/12"
            />
            <span
              className="grow select-none text-xs font-extralight italic dark:text-white/70 md:text-sm"
            >
              appreciate you&apos;re here for analytics. despite having no real users. 👀
            </span>
          </div>
          <hr
            className="border-1 ml-auto w-7/12 animate-pulse border-[#877474] border-opacity-50"
          />
        </div>
      </header>


      <section className="max-w-8xl card flex w-full flex-col justify-center space-y-4 rounded-3xl border bg-gradient-radial from-gray-50 to-gray-200 px-8 py-12 dark:from-yellow-700/10 dark:to-[#080812] sm:min-h-fit md:px-16 md:py-24">
        ...
        <h1 className="max-w-3xl font-heading text-4xl font-bold sm:text-8xl ">
          Yet Another <br className="" />
          <span className="bg-gradient-to-br from-orange-400 to-gray-200 bg-clip-text uppercase text-transparent dark:from-gray-200 dark:to-orange-400">web analytics</span>
        </h1>
        <div className="flex flex-col gap-3 font-semibold ">
          <p className="max-w-xl text-left text-xl tracking-wider text-orange-500">3 Easy Step To Setup</p>
          <div className="text-md flex flex-col gap-4 text-black dark:text-white sm:flex-row sm:text-lg">
            <div className="flex gap-2">
              <span className="bg-gradient-to-br from-indigo-300 to-orange-600 bg-clip-text text-transparent">01</span>
              <span className=" ">Create account</span>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="hidden aspect-square w-5 stroke-orange-300 stroke-2 sm:block">
              <path strokeLinecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" />
            </svg>
            <div className="flex gap-2">
              <span className="bg-gradient-to-br from-indigo-300 to-orange-600 bg-clip-text text-transparent">02</span>
            ...
            <div className="flex gap-2">
              <span className="bg-gradient-to-br from-indigo-300 to-orange-600 bg-clip-text text-transparent">03</span>
        ...
        <div className="flex flex-col  gap-6 font-semibold sm:flex-row ">
          <button className="group relative h-12 w-[170px] overflow-hidden rounded-lg px-8  py-3 text-white/80 dark:text-gray-400">
            ...
            <Link className="absolute inset-0.5 flex w-40 items-center  justify-center rounded-md bg-gray-900/95 uppercase transition-all duration-500 hover:text-white/80 group-hover:bg-gray-900" href="/login">
              Get Started
            </Link>
          </button>
          <Link href="https://docs.loglib.io" className=" flex items-center gap-4 rounded-md text-gray-600 transition-all duration-500 hover:gap-8 hover:text-gray-400">
            <span>
              Read The Doc
            </span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="aspect-square w-5 stroke-orange-300 stroke-2 ">
              <path strokeLinecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" />
            </svg>
          </Link>
        </div>
      ...
      <div className="max-w-8xl flex w-full items-end justify-end gap-8 pl-10">
        ...
        <div
          className="border-gold/40  h-16 w-7/12 border-y border-l bg-zinc-400 bg-opacity-60 dark:bg-gray-800"
        >
        </div>
      </div>
      ...
      <section className="max-w-8xl relative mx-4 w-full md:mx-0">
        ...
        <div
          className="relative flex w-10/12 border-spacing-2 flex-col items-center border border-black/20 p-6 decoration-dashed dark:border-white/20 md:w-1/2 lg:flex-row lg:space-x-8"
        >

          <svg version="1.1" className=" h-16 w-16 fill-gray-800 dark:fill-white/90" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200" enable-background="new 0 0 1200 1200" xmlSpace="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="layer1" transform="translate(0,147.63782)"> <path id="path2996" d="M600.073-130.212C268.728-130.212,0,138.37,0,469.715 c0,260.491,166.117,482.172,398.146,565.076L546.04,643.675c-74.269-23.013-128.273-92.136-128.273-173.96 c0-100.646,81.661-182.307,182.308-182.307c100.646,0,182.16,81.661,182.16,182.307c0,81.888-53.952,151.147-128.273,174.106 l147.896,391.115C1033.938,952.082,1200,730.271,1200,469.715C1200,138.37,931.419-130.212,600.073-130.212z"></path> </g> </g></svg>
          <div>
            <p
              className="bg-clip-text text-xl font-bold md:text-3xl"
            >
              Open source & Privacy First
            </p>
            <p className="max-w-md text-sm">
              Loglib is open source and  privacy first. It&apos;s compliant with GDPR and CCPA. Its doesn&apos;t collect any personal data and we don&apos;t use cookies.
            </p>
          </div>
        </div>
        ...
        <div
          className="ml-auto flex w-10/12 border-spacing-2 flex-col items-center border border-dashed border-black/40 border-opacity-25 bg-white/10 p-6 px-10 dark:border-white/25 dark:bg-black/10 md:w-1/2 lg:flex-row lg:space-x-5"
        >

          <svg height="200px" className=" h-16 w-16 fill-gray-800 dark:fill-white/90" width="200px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlSpace="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path d="M153.527,138.934c-0.29,0-0.581,0.088-0.826,0.258L0.641,242.995C0.238,243.27,0,243.721,0,244.213v27.921 c0,0.484,0.238,0.943,0.641,1.21l152.06,103.811c0.246,0.17,0.536,0.258,0.826,0.258c0.238,0,0.468-0.064,0.686-0.169 c0.484-0.258,0.782-0.758,0.782-1.306v-44.478c0-0.476-0.238-0.936-0.641-1.202L48.769,258.166l105.585-72.068 c0.403-0.282,0.641-0.734,0.641-1.226V140.41c0-0.548-0.298-1.049-0.782-1.299C153.995,138.991,153.765,138.934,153.527,138.934z"></path> <path d="M511.358,242.995l-152.06-103.803c-0.246-0.169-0.536-0.258-0.827-0.258c-0.238,0-0.467,0.056-0.685,0.177 c-0.484,0.25-0.782,0.751-0.782,1.299v44.478c0,0.484,0.238,0.936,0.641,1.21l105.586,72.068l-105.586,72.092 c-0.403,0.266-0.641,0.725-0.641,1.217v44.462c0,0.548,0.298,1.049,0.782,1.306c0.218,0.105,0.448,0.169,0.685,0.169 c0.291,0,0.581-0.088,0.827-0.258l152.06-103.811c0.404-0.267,0.642-0.726,0.642-1.21v-27.921 C512,243.721,511.762,243.27,511.358,242.995z"></path> <path d="M325.507,114.594h-42.502c-0.629,0-1.186,0.395-1.387,0.984l-96.517,279.885 c-0.153,0.443-0.08,0.943,0.194,1.322c0.278,0.387,0.722,0.621,1.198,0.621h42.506c0.625,0,1.182-0.395,1.387-0.992l96.513-279.868 c0.153-0.452,0.081-0.952-0.193-1.339C326.427,114.828,325.982,114.594,325.507,114.594z"></path> </g> </g></svg>

          <div>
            <p className="text-xl font-bold md:text-3xl">Embeddable in your app</p>
            <p className="max-w-md text-sm">
              The self hosted version of loglib is fully embeddable inside your app and can use your current database. <Link target="_blank" className=" text-blue-500" href="https://github.com/loglib/loglib">
                Learn more
              </Link>
            </p>
          </div>
        ...
        <div
          className="-mt-2 flex w-10/12 border-spacing-2 flex-col items-center space-x-4 border border-black/20 border-opacity-25 p-6 dark:border-white/25 md:w-[52%] lg:flex-row"
        >
          <svg
            width="80"
            height="80"
          ...
          >
            <path
              ...
              className="fill-black/80 dark:fill-[#CED2CD]"></path>
          </svg>
          <div>
            ...
            <p className="max-w-md text-sm">
              With automatic and manual event tracking view how users interact with your website.
            </p>
          </div>
        </div>
        <div
          className="relative -mt-3 ml-auto flex w-10/12 border-spacing-2 flex-col items-center border border-black/40 border-opacity-25 bg-white/10 p-6 px-10 dark:border-white/25 dark:bg-black/10 md:w-[50%] lg:flex-row lg:space-x-5"
        >
          <svg className=" h-16 w-16 fill-gray-800 dark:fill-white/90" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div
          className="relative flex w-10/12 border-spacing-8 flex-col items-center space-x-4 border border-dashed border-black/20 p-6 decoration-dashed dark:border-white/25 md:w-1/2 lg:flex-row"
        >
          <div
            className="absolute -left-4 -top-5 border border-dashed border-black/50 p-1 dark:border-white/40"
          >
            <div
              className="bg-gradient-to-tr from-orange-800/80 to-yellow-700 px-2 py-1 text-xs font-bold text-white md:text-sm"
            >
              New Release
            </div>
          </div>
          ...
          >
            <path
              ...
              fill="#DDDDDD"
              className="fill-black/80 dark:fill-[#DDDDDD]"></path>
          </svg>

          <div>
            <p className="text-xl font-bold md:text-3xl">Rest Api</p>
            <p className="max-w-md text-sm">
              Our rest api will provide you a way to repurpose your data for any other use case. You can get your data as you should and use it for your own purposes.
            </p>
          </div>
        </div>
      ...
      <section >
        <div className="relative z-10 mx-auto max-w-screen-lg items-center px-4  py-8 text-center md:py-20">
          <p className="font-bold text-neutral-400 line-through">you can pretend this is true</p>
          <p className="mb-8 font-mono text-neutral-400">
            Trusted by
            <span className="bg-gradient-to-br from-logo to-orange-600 bg-clip-text font-black text-transparent"> 100,000+ </span>
            engineers at
          </p>
          <ul className="mx-auto flex flex-wrap items-center justify-center gap-10 md:gap-12">
            <img src="/assets/Icons/companies/atlassian.svg" className="h-4 bg-gradient-to-br from-indigo-600 to-orange-600 bg-clip-text fill-transparent opacity-75 invert transition hover:opacity-100 dark:invert-0 md:h-6" alt="" />
            <img src="/assets/Icons/companies/github.svg" className="h-4 bg-gradient-to-br from-indigo-600 to-orange-600 bg-clip-text fill-transparent opacity-75 invert transition hover:opacity-100 dark:invert-0 md:h-6" alt="" />
            <img src="/assets/Icons/companies/google.svg" className="h-4 bg-gradient-to-br from-indigo-600 to-orange-600 bg-clip-text fill-transparent opacity-75 invert transition hover:opacity-100 dark:invert-0 md:h-8" alt="" />
            <img src="/assets/Icons/companies/microsoft.svg" className="h-4 bg-gradient-to-br from-indigo-600 to-orange-600 bg-clip-text fill-transparent opacity-75 invert transition hover:opacity-100 dark:invert-0 md:h-7" alt="" />
            <img src="/assets/Icons/companies/airbnb.svg" className="h-4 bg-gradient-to-br from-indigo-600 to-orange-600 bg-clip-text fill-transparent opacity-75 invert transition hover:opacity-100 dark:invert-0 md:h-8" alt="" />
            <img src="/assets/Icons/companies/cisco.svg" className="h-6 bg-gradient-to-br from-indigo-600 to-orange-600 bg-clip-text fill-transparent opacity-75 invert transition hover:opacity-100 dark:invert-0 md:h-8" alt="" />
            <img src="/assets/Icons/companies/amazon.svg" className="h-5 bg-gradient-to-br from-indigo-600 to-orange-600 bg-clip-text fill-transparent opacity-75 invert transition hover:opacity-100 dark:invert-0 md:h-7" alt="" />
            <img src="/assets/Icons/companies/paypal.svg" className="h-5 bg-gradient-to-br from-indigo-600 to-orange-600 bg-clip-text fill-transparent opacity-75 invert transition hover:opacity-100 dark:invert-0 md:h-7" alt="" />
          </ul>
        </div>
      </section>
      ...
      <section className=" max-w-8xl relative mx-auto my-10  flex w-full flex-wrap items-center justify-center gap-20 p-4 sm:px-16 ">
        <div className=" flex items-center  justify-center py-4 sm:gap-20 ">
          <div className="absolute left-0 top-0 flex h-full w-full flex-col items-center justify-center gap-8 px-4 text-center dark:bg-[#080812]/40  sm:gap-4">
            <h1 className="max-w-3xl font-heading text-2xl font-bold sm:text-4xl">
              <a href="https://github.com/LogLib/loglib" className="italic">Loglib </a>
              works with
              <span className="bg-gradient-to-br from-logo to-orange-600 bg-clip-text font-black uppercase text-transparent"> any </span>
              language and framework
            </h1>
            <p className="max-w-lg">It effortlessly works with any JavaScript ecosystem, even in pure HTML via a CDN. And yes, it can also charm its way into the enchanting world of
              <Link href="https://github.com/LogLib/loglib-wordpress-plugin.git" target="_blank" className=" text-blue-500">
                {" "}WordPress</Link>
            </p>
          </div>
      ...
      <section className="max-w-8xl to-50 mx-auto mt-10 w-full rounded-3xl  bg-gradient-to-br from-gray-100 px-4 dark:from-gray-700/25 dark:to-[#080812] sm:px-16 ">
        <div className="flex h-full w-full flex-col justify-center gap-8 py-12">
          <h1 className="max-w-3xl font-heading text-3xl font-bold sm:text-6xl">
            Supported by the
            <span className="bg-gradient-to-br from-logo to-orange-600 bg-clip-text font-black uppercase text-transparent"> Dope </span>#community
          </h1>
          <div className="flex flex-col gap-10 font-semibold sm:flex-row sm:gap-20">
            <div className="flex flex-col items-center justify-center rounded-lg  border border-gray-900 px-16 py-4 transition-colors duration-500 hover:border-gray-800">
              <div>
                <h1 className="bg-gradient-to-bl from-red-500 to-indigo-700 bg-clip-text font-heading text-5xl font-black text-transparent ">
                  0{stars}
                </h1>
                <p className="text-md font-mono font-thin opacity-75">GitHub Stars</p>
              </div>
            </div>
            <div className="flex flex-col items-center justify-center rounded-lg  border border-gray-900 px-16 py-4 transition-colors duration-500 hover:border-gray-800">
              <div>
                <h1 className="bg-gradient-to-tr from-red-500 to-indigo-700 bg-clip-text font-heading text-5xl font-black text-transparent ">
                  127
                </h1>
                <p className="text-md font-mono font-thin opacity-75">Community</p>
              </div>
            </div>
            <div className="flex flex-col items-center justify-center rounded-lg  border border-gray-900 px-16 py-4 transition-colors duration-500 hover:border-gray-800">
              <div>
                <h1 className="bg-gradient-to-br from-red-500 to-indigo-700 bg-clip-text font-heading text-5xl font-black text-transparent ">
                  {
                    contributors <= 10 ? "00" + contributors :
                      contributors <= 100 ? "0" + contributors :
                        contributors
                  }
                </h1>
                <p className="text-md font-mono font-thin opacity-75">Contributors</p>
              </div>
            </div>
          </div>
        </div>
