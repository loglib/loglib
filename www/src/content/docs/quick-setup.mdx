...
<Callout>
  ...
  setup and it's free for now. The setup below is for the pacakge version. If
  you want to use the hosted version you can go to the [dashboard](/dashboard)
  and create a new project and follow the instructions there.
</Callout>

Currently LogLib supports Next JS. But if you want to use LogLib with other
frameworks, you can sill deploy loglib seaprtley and use the tracker in ur
site.
