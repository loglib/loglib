...
export function SiteHeader({ user }: { user?: User }) {
    ...
    return (
        <header className="flex items-center justify-between">
            <Icons.logoWithLetter logoClassName=" w-10 h-10" headerClassName=" text-3xl" />
            <div className="flex items-center gap-2 font-medium">
                ...
                <div
                    className="relative col-span-1 select-none flex-col items-center justify-center self-center lg:flex"
                >
                    ...
                    <audio id="switch-on" ref={switchOnRef} src="/audio/switch-on.mp3"></audio>
                    <audio id="switch-off" ref={switchOffRef} src="/audio/switch-off.mp3"></audio>
                </div>
            </div>
        </header>
    )
...
export function DashboardHeader({ user }: { user: User }) {
    ...
    const switchOffRef = useRef<HTMLAudioElement>(null)
    return (
        <header className="mt-4 flex items-center justify-between border-b pb-4">
            <Icons.logoWithLetter logoClassName=" w-10 h-10" headerClassName=" text-3xl" />
            <div className="flex items-center gap-2 font-medium">
                <div
                    className="relative col-span-1 select-none flex-col items-center justify-center self-center lg:flex"
